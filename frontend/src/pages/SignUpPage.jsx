...
function SignUpPage() {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center p-4 bg-slate-950 transition-colors duration-500 overflow-hidden relative">
      ...
      <div className="absolute top-1/4 -left-20 size-96 bg-emerald-500/10 blur-[120px] rounded-full" />
      <div className="absolute bottom-1/4 -right-20 size-96 bg-brand-secondary/10 blur-[120px] rounded-full" />
        ...
        <div className="w-full flex flex-col md:flex-row min-h-[600px] md:h-[700px]">
          ...
          <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center border-b md:border-b-0 md:border-r border-white/5 relative z-10">
            <div className="w-full max-w-md mx-auto">
              ...
              <div className="text-center md:text-left mb-8">
                ...
                <p className="text-slate-400 font-medium leading-relaxed">Join our secure messaging community today</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative group">
                    <UserIcon className="auth-input-icon group-focus-within:text-emerald-500 transition-colors" />
          ...
          <div className="hidden md:w-1/2 md:flex flex-col items-center justify-center p-12 bg-white/[0.02] relative overflow-hidden">
            <div className="relative z-10 text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-4 tracking-tight">Your Privacy, Guaranteed</h3>
              <p className="text-slate-400 max-w-sm mx-auto mb-8 font-medium">Join thousands of users who trust us for their daily professional communication.</p>
